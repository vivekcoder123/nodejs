(function($) {
    ...
    function mainSlider() {
        ...
        homeBanner.not('.slick-initialized').slick({
            autoplay: true,
            speed: 1000,
    ...
    $(function() {
        ...
        $('.ps-product--quickview .ps-product__images').not('.slick-initialized').slick({
            slidesToShow: 1,
            slidesToScroll: 1,
            fade: true,
            dots: false,
    ...
    $('#product-quickview').on('shown.bs.modal', function(e) {
        $('.ps-product--quickview .ps-product__images').not('.slick-initialized').slick('setPosition');
    });
